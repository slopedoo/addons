...
do
	local t = {
		blizzard = function(frame)
			...
			frame.count:SetFont([[Fonts\big_noodle_titling.ttf]], 15, 'THICKOUTLINE')
		end,
		zoomed = function(frame)
			...
			frame.count:SetFont([[Fonts\big_noodle_titling.ttf]], 17, 'THICKOUTLINE')
		end,
		...
		modui = function(frame)
			...
			frame.count:SetFont([[Fonts\big_noodle_titling.ttf]], 16, 'THICKOUTLINE')
		end,
	}
...
do
	...
	function time_text(t)
		...
		elseif t > MINUTE then
			return color_code(1, 1, 1) .. ceil(t / MINUTE * 10) / 10
		elseif t > 5 then
			return color_code(1, 1, 1) .. ceil(t)
		else
			return color_code(1, 1, 1) .. ceil(t)
		end
	end
