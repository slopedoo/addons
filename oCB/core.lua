...
local Fonts 		= {
	...
	["BIGNOODLE"] 	= "Interface\\AddOns\\oCB\\fonts\\big_noodle_titling.ttf",
							...
							spell = {
								...
								args = {
									...
									font = {
										...
										validate = {"Adventure", "Backsplatter", "Bazooka", "BlackCastleMF", "Budhand", "Comic", "Cooline", "Creeper", "Defused", "Exocet", "FuturaBold", "Mailrays", "Pepsi", "Porky", "Signature", "Visitor1", "Visitor2", "BIGNOODLE", "Yellowjacket", "Friz Quadrata", "Arial Narrow", "Skurri", "Morpheus"}
									},
									outline = {
