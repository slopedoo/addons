...
RAB_Buffs = 	{
			...
			wisdom={name="Distilled Wisdom",textures={"INV_Potion_97"},castClass="Item",invert=true,havebuff="Distilled Wisdom",missbuff="Not Distilled Wisdom",type="buff"},
			mageblood={name="Mana Regeneration",textures={"INV_Potion_45"},castClass="Item",invert=true,havebuff="Mana Regeneration",missbuff="Not Mana Regeneration",type="buff"},
			mistletoe={name="Mistletoe",textures={"Spell_Nature_HealingTouch"},castClass="Item",invert=true,havebuff="Mistletoe",missbuff="Not Mistletoe",type="buff"},
			...
			naturepot={name="GNPP",textures={"Spell_Nature_SpiritArmor"},castClass="Item",invert=true,havebuff="Nature Protection",missbuff="Not Nature Protection",type="buff"},
			shadowpot={name="GSPP",textures={"Spell_Shadow_RagingScream"},castClass="Item",invert=true,havebuff="Shadow Protection",missbuff="Not Shadow Protection",type="buff"},
			firepot={name="GFPP",textures={"Spell_Fire_FireArmor"},castClass="Item",invert=true,havebuff="Fire Protection",missbuff="Not Fire Protection",type="buff"},
